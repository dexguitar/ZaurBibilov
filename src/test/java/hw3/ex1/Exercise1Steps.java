...
//        Assert that there are 4 texts on the Index Page under icons and they have proper text
        // TODO el -> el.getText() could be replaced to WebElement::getText
...
//        Epam logo in the left top corner of iframe
        ...
        homePageSteps.assertIsDisplayed(hp.getEpamLogo());
...
//        Assert that JDI GITHUB is a link and has a proper URL
        homePageSteps.assertIsDisplayed(hp.getJdiLink());
        homePageSteps.assertProperLinkValue(hp.getJdiLink(), hp.JDI_LINK_URL);

//        Assert that there is Left Section
        WebElement leftSection = hp.getLeftSection();
        homePageSteps.assertIsDisplayed(leftSection);

//        Assert that there is Footer
        WebElement footer = hp.getFooter();
        homePageSteps.assertIsDisplayed(footer);
    }
